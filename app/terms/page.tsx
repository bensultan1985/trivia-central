        ...
        <div className="rounded-lg bg-white p-6 shadow-lg dark:bg-slate-900">
          <div className="prose prose-slate dark:prose-invert max-w-none">
            ...
            <ul className="list-disc list-inside text-slate-600 dark:text-slate-300 mb-4 space-y-2">
              <li>
                Personal Data: Name, email address, and other contact
                information you voluntarily provide
              </li>
              <li>
                Usage Data: Information about how you use our application,
                including game statistics and performance data
              </li>
              <li>
                Device Data: Information about your device, browser type, and
                operating system
              </li>
            </ul>
            <h2 className="text-2xl font-semibold mt-6 mb-4 text-slate-900 dark:text-slate-50">
